...
func NewTranslatorProcessor(handler Translator) *TranslatorProcessor {
	...
	self2 := &TranslatorProcessor{handler: handler, processorMap: make(map[string]thrift.TProcessorFunction)}
	self2.processorMap["ping"] = &translatorProcessorPing{handler: handler}
	return self2
}
